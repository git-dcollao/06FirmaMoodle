...
$string['signature_already_signed'] = 'You have already signed this document';
$string['signature_signedat'] = 'Signed on';
$string['signature_download_pdf'] = 'Download signed PDF';
$string['signature_resign'] = 'Sign again';
$string['verify'] = 'Verify authenticity';
$string['course_no_documents'] = 'No documents available to sign in this course.';
$string['btn_sign'] = 'Sign document';
...
$string['pdf_dimensions_info'] = 'PDF dimensions (page 1): <strong>{$a->width}mm</strong> (~{$a->widthpx}px) x <strong>{$a->height}mm</strong> (~{$a->heightpx}px). Orientation: {$a->orientation}';
$string['error_coordinate_out_of_bounds'] = 'The coordinate exceeds the page size ({$a}mm).';
...
$string['fieldeditor_step1'] = 'Click <strong>"+ Add field"</strong> to add a new field to the document.';
$string['fieldeditor_step2'] = 'In the right panel, choose the <strong>field source</strong> (student name, signature date, handwritten signature, etc.).';
$string['fieldeditor_step3'] = '<strong>Drag the field</strong> over the PDF preview to position it. You can also adjust X/Y coordinates manually.';
$string['fieldeditor_step4'] = 'Click <strong>"Save layout"</strong> to apply your changes.';
$string['fieldeditor_nopdfjs'] = 'PDF preview is not available on this server. You can add and position fields using the manual X/Y coordinates.';
