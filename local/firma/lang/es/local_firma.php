...
$string['signature_already_signed'] = 'Ya firmaste este documento';
$string['signature_signedat'] = 'Fecha de firma';
$string['signature_download_pdf'] = 'Descargar PDF firmado';
$string['signature_resign'] = 'Volver a firmar';
$string['verify'] = 'Verificar autenticidad';
$string['course_no_documents'] = 'No hay documentos disponibles para firmar en este curso.';
$string['btn_sign'] = 'Firmar documento';
...
$string['pdf_dimensions_info'] = 'Dimensiones PDF (pág. 1): <strong>{$a->width}mm</strong> (~{$a->widthpx}px) x <strong>{$a->height}mm</strong> (~{$a->heightpx}px). Orientación: {$a->orientation}';
$string['error_coordinate_out_of_bounds'] = 'La coordenada supera el tamaño de la página ({$a}mm).';
...
$string['fieldeditor_instructions'] = 'Arrastra cada campo sobre la vista previa del PDF para posicionarlo. Ajusta su tamaño y etiqueta desde la lista lateral. <br><strong>Importante:</strong> Debes hacer clic en "Guardar diseño" para aplicar los cambios.';
$string['fieldeditor_step1'] = 'Haz clic en <strong>"+ Agregar campo"</strong> para añadir un campo al documento.';
$string['fieldeditor_step2'] = 'En el panel derecho, elige la <strong>fuente de datos</strong> del campo (nombre del estudiante, fecha de firma, firma manuscrita, etc.).';
$string['fieldeditor_step3'] = '<strong>Arrastra el campo</strong> sobre la vista previa del PDF para posicionarlo. También puedes ajustar las coordenadas X/Y manualmente.';
$string['fieldeditor_step4'] = 'Haz clic en <strong>"Guardar diseño"</strong> para aplicar los cambios.';
$string['fieldeditor_nopdfjs'] = 'La vista previa del PDF no está disponible en este servidor. Puedes añadir y posicionar campos usando las coordenadas X/Y de forma manual.';
...
$string['field_help'] = 'Configure los campos que se estamparán sobre el PDF. Las coordenadas X/Y son en milímetros.';
